    ...
    <div className="main-container my-3">
      ...
      <div className="row">
        <div className="col-lg-12 col-md-12 col-sm-12 col-12">
          ...
          <table className="table table-striped text-primary-color font-size-medium table-responsive-md table-bordered mt-3">
            <thead>
          ...
          <Button
            type="button"
            onClick={() => router.push(routes.organize.licenses.create)}
            className="mt-4"
          >
            New License
          </Button>
...
export default AdviceLicensesPage;
