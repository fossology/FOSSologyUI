      ...
      <div className="main-container my-3">
        <div>
          ...
          <ul className="triangle-bullets">
            ...
            <li>Find copyrights, URLs and email addresses</li>
            <li>Classify licenses into user definable categories (aka buckets)</li>
        ...
        <div>
          <h2 className="text-primary-color font-size-sub-heading">How to Begin</h2>
          <p>
        ...
        <div className="row m-0">
          <div className="col-md-6 col-lg-6 p-md-0">
            <h2 className="text-primary-color font-size-sub-heading">Inside FOSSology</h2>
            <p>
              Some parts of FOSSology helpful to know about are:
              <br /> <br />
              <b>Software Repository</b> - Stores files uploaded for analysis. <br />
              <b>Database</b> - Stores user accounts, file information, and
              analysis results.<br />
              <b>Agents</b> - Perform analysis of files and data found in the
              Software Repository and Database.<br />
          ...
          <div className="col p-md-0">
            <Image
              src="/assets/images/fossologyFlow.svg"
              alt="fossology flow"
              width="173"
              height="259"
              className="mx-auto mx-md-0"
        ...
        <div>
          <h2 className="text-primary-color font-size-sub-heading">Need Some Help?</h2>
          <p>
            Now that you have been introduced to Fossology, try exploring it!<br />
            The following resources will provide additional help and
            information:<br /> <br />
            <a
