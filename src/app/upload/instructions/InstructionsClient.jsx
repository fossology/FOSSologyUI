    ...
    <div className="main-container my-3">
      ...
      <ul>
        <li>
          ...
          <Link href={routes.upload.file}>Upload File</Link> option to select and upload the file.
          <ul>
            <li>
              While this can be very convenient (particularly if the file is
              not readily accessible online), uploading via your web browser
              can be slow for large files, and files larger than 650 Megabytes
              may not be uploadable.
            </li>
          </ul>
        </li>
        <li>
          <b>On a remote server</b>. Use the{" "}
          <Link href={routes.upload.url}>Upload from URL</Link> option to specify a remote server.
          <ul>
            <li>
        ...
        <li>
          ...
          <Link href={routes.upload.server}>Upload from Server</Link> option to specify a file or path on the server.
          <ul>
            <li>
        ...
        <li>
          ...
          <Link href={routes.upload.vcs}>Upload from Version Control System</Link> option to specify URL of a repo.
        </li>
      </ul>
      If your system is configured to use multiple agent servers, the data
      area must be mounted and accessible to the FOSSology user (fossy) on
      every agent system. See the section
